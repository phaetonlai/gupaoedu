 ...
 * 人寿险核心退保处理类
 */
public class PropertyCoreSurrenderService {
    public ResultInfo propertySurrender(ContractEO contractEO) {
        System.out.println("产险核心退保处理开始。。。");
        System.out.println("退保的保单号：" + contractEO.getContNo());
        System.out.println("产险核心退保处理完毕。。。");
