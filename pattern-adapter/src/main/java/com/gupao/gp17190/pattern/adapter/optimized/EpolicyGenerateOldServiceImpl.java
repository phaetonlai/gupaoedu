 ...
 * @description
 **/
public class EpolicyGenerateOldServiceImpl implements IEpolicyGenerateService {
    ...
    public ResultInfo epolicyGen(EpolicyRequestDto dto) {
        ...
        System.out.println("优化后，调用老接口生成电子保单。。。");
        System.out.println("优化后，调用老接口生成电子保单完成。。。");

        ResultInfo resultInfo = new ResultInfo();
        resultInfo.setSuccess(true);
        resultInfo.setMsg("保单号：【" + dto.getPolicyNo() + "】，调用老接口，处理是否成功：【" + resultInfo.isSuccess() + "】");
